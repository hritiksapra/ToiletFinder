    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new startUrl().execute("http://172.16.5.227:8084/ToiletFinderServer/resources/ToiletFinderServer/PostToiletInfo", Double.toString(latitude), Double.toString(longitiude), getHygieneRating(), getSafetyRating(), name, email );
            }
        });
    }
